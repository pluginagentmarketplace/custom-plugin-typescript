...
This guide provides comprehensive documentation for the **advanced-types** skill in the custom-plugin-typescript plugin.
...
```bash
# Invoke the skill
claude "advanced-types - [your task description]"

# Example
claude "advanced-types - analyze the current implementation"
```
...
def implement_advanced_types(input_data):
    """
    Implement advanced-types functionality.
