...
This guide provides comprehensive documentation for the **fundamentals** skill in the custom-plugin-typescript plugin.
...
```bash
# Invoke the skill
claude "fundamentals - [your task description]"

# Example
claude "fundamentals - analyze the current implementation"
```
...
def implement_fundamentals(input_data):
    """
    Implement fundamentals functionality.
