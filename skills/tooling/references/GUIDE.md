...
This guide provides comprehensive documentation for the **tooling** skill in the custom-plugin-typescript plugin.
...
```bash
# Invoke the skill
claude "tooling - [your task description]"

# Example
claude "tooling - analyze the current implementation"
```
...
def implement_tooling(input_data):
    """
    Implement tooling functionality.
